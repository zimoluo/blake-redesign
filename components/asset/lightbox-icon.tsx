  ...
  return (
    ...
    >
      <circle
        ...
        cy={374.5}
        r={333.5}
        fill="url(#abhelgrirueflafawhuie)"
      ...
      <circle
        ...
        cy={829.5}
        r={333.5}
        fill="url(#bfjaiowejowipajfgnreifnai)"
        className="dark:opacity-0"
      />
      <path
        fill="url(#cfjioeriofjaeriaojewffjnjervg)"
      ...
      />
      <path
        fill="url(#dajiroeafweijaiwjaiefhawlu)"
        className="dark:opacity-20"
      ...
      <defs>
        ...
        <radialGradient
          id="cfjioeriofjaeriaojewffjnjervg"
          cx={0}
          cy={0}
          r={1}
